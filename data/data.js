module.exports =
{
    ...
    "conference_claim": "12ª Edición de la cita tecnológica anual más esperada en Bilbao",
    "conference_date": "27 de Enero 2024, Palacio Euskalduna Jauregia, Bilbao",
    "conference_hashtag": "#bilbostack24",
    "location": {
    ...
    "speakers": [
        ...
        },
        {
            ...
            "bio": "¡Holi! Soy Mario López, <a href='https://brain.drmario.tech/pages/%E2%9C%8D%EF%B8%8F+Acho.+Qu%C3%A9+has+estado+haciendo+estos+%C3%BAltimos+tres+a%C3%B1os.+(2015)' target='_blank'>doctor teleco de formación</a> pero ingeniero de software de convicción. Trabajo como Head of Data <a href='https://brain.drmario.tech/pages/My+engineering+management+principles%2C+values%2C+and+practices' target='_blank'>“asín”</a> en <a href='https://brain.drmario.tech/pages/Freepik' target='_blank'>Freepik</a> , ex-<a href='https://brain.drmario.tech/pages/Mercadona+Tech' target='_blank'>Mercadona Tech</a>, ex-<a href='https://brain.drmario.tech/pages/Unlimiteck' target='blank'>Unlimiteck</a>. Me presento mejor profesionalmente en el <a href='https://brain.drmario.tech/pages/CV+-+Mario+L%C3%B3pez+Mart%C3%ADnez' target='_blank'>CV</a>. <br/><br/>Me interesa mi curro: <a href='https://brain.drmario.tech/pages/Working+in+Data' target='_blank'>Working in Data</a>, <a href='https://brain.drmario.tech/pages/Engineering+Management' target='_blank'>Engineering Management</a> , <a href='https://tinyurl.com/yfsw3a3d' target='_blank'>🦜 No matter how it looks at first, it's always a people problem</a>...) <br/><br/>Pero ella es también poliédrica, y le interesan: <a href='https://brain.drmario.tech/pages/%E2%9C%8D%EF%B8%8F+Sin+machirulos+hay+paraiso.+Una+charla+heterofriendly+sobre+management' target='_blank'>🏳️‍🌈 los hombres</a>, y otros <a href='https://brain.drmario.tech/pages/Human+affairs' target='_blank'>Human affairs</a>, <a href='https://brain.drmario.tech/pages/Writing+is+thinking' target='_blank'>Writing is thinking</a>, videojuegos no tragaperrescos, <a href='https://brain.drmario.tech/pages/%F0%9F%93%96+True+Story.+What+Reality+TV+Says+About+Us' target='_blank'>reality shows</a> de competición de USA, y <a href='https://brain.drmario.tech/pages/Fitness' target='_blank'>ponerse mazadísimo</a> y me hice monitor de fisioculturismo para ver si lo podía aplicar conmigo (como hacen los psicólogos).",
            "social": {
                "twitter": "",
